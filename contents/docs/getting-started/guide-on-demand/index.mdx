### Catopay API Documentation (Updated)

Welcome to the updated Catopay API documentation. Follow these steps to seamlessly integrate Catopay's payment services into your application.
...
For more advanced use cases, visit the [Catopay developer portal](https://catopay.com/dashboard/api-keys).
